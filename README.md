...
- https://github.com/boam79/DocuLensLocal/releases/download/v0.1.12/DocuLensLocal-win-Setup.exe
...
본문 검색·OCR은 v0.1.12 설치본과 이 저장소의 `dotnet run`에 들어 있습니다. 앱을 켜면 검색창만 보입니다. 검색한 뒤 **초기화**를 누르면 다시 검색창만 남습니다. 예전에 파일명만 인덱싱된 경우, 앱을 켜면 자동으로 본문을 다시 읽습니다.
