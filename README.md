...
- https://github.com/boam79/DocuLensLocal/releases/download/v0.1.21/DocuLensLocal-win-Setup.exe
...
이미 인덱싱한 폴더에 Excel만 빠져 있었다면 **새 파일 인덱싱**으로도 읽힙니다. 앱을 켠 채 폴더에 `.xlsx`를 넣으면 자동으로 그 파일만 읽습니다.
