...
- https://github.com/boam79/DocuLensLocal/releases/download/v0.1.24/DocuLensLocal-win-Setup.exe
...
검색창 아래 **PDF / WORD / HWP / EXCEL**을 누른 뒤 검색하면 그 종류만 나옵니다. 같은 칸을 다시 누르면 모든 종류를 찾습니다.
