...
- https://github.com/boam79/DocuLensLocal/releases/download/v0.1.13/DocuLensLocal-win-Setup.exe
...
본문 검색·OCR은 v0.1.13 설치본과 이 저장소의 `dotnet run`에 들어 있습니다. 앱을 켜면 검색창과 예시 단어만 보입니다. 검색한 뒤 **초기화**를 누르면 다시 처음 화면으로 돌아갑니다.
