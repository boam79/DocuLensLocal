...
- https://github.com/boam79/DocuLensLocal/releases/download/v0.1.19/DocuLensLocal-win-Setup.exe
...
폴더에 PDF·Word·한글을 **나중에 더 넣으면** 앱을 다시 켜거나 아래 **새 파일 인덱싱**을 누르세요. 이미 읽은 파일은 그대로 두고 새로 넣거나 바뀐 파일만 읽습니다. **처음부터 다시 인덱싱**은 검색 목록을 지운 뒤 전부 다시 읽을 때만 쓰세요.
